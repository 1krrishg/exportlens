                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      <div className="text-[10px] text-muted-foreground font-mono">additional duty · HS {t.hs_code}</div>
                    </div>
                  </div>
                );
              })}
          ...
          <div>
            ...
            <div className="rounded-xl border border-border bg-card overflow-hidden">
              <div className="px-4 py-3 border-b border-border bg-muted/30 flex items-center gap-2">
                <span className={`h-1.5 w-1.5 rounded-full ${dataStale ? "bg-warning" : "bg-success animate-pulse"}`} />
                <span className="text-xs font-medium text-foreground">{dataStale ? "Scraper idle" : "Scraper active"}</span>
              </div>
