        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-5 lg:pt-6">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-secondary border border-border text-[11px] sm:text-xs text-muted-foreground mb-5">
              ...
              USITC · WTO API · CBP CROSS · updated daily
            </div>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-muted-foreground">
              ...
              <span className="flex items-center gap-1.5"><Globe className="h-3.5 w-3.5 text-primary" /> WTO bound rate · trade flows · FTA savings</span>
              <span className="flex items-center gap-1.5"><Database className="h-3.5 w-3.5 text-warning" /> FDA · CPSC · EPA · FCC · USDA compliance flags</span>
            </div>
          </div>
