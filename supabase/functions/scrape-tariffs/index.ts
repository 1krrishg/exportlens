...
const KEY_HS_CODES: { hs4: string; name: string }[] = [
  ...
  { hs4: "7604", name: "Aluminum extrusions" },
  ...
  // High-import-volume electronics missing Section 301 coverage
  { hs4: "8504", name: "Power Supplies/Transformers" },
  { hs4: "8528", name: "Monitors/TVs/Displays" },
  { hs4: "8529", name: "Parts for Radio/TV Apparatus" },
  { hs4: "8536", name: "Electrical Switches/Connectors" },
  { hs4: "8544", name: "Insulated Wire/Cable" },
  { hs4: "9503", name: "Toys/Games" },
  { hs4: "6404", name: "Footwear (textile upper)" },
  { hs4: "8414", name: "Air Pumps/Compressors/Fans" },
];
...
const KNOWN_RETALIATIONS: {
  ...
  { hs_code: "8708", product_name: "Auto Parts", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 25, retaliation_note: "US Section 301 List 2 (USTR, 2018) — 25% additional on Chinese-origin auto parts. EV batteries and components also 25% (Biden 2024), lithium-ion EV batteries escalating to 50% by 2026." },
  ...
  // Aluminum EXTRUSIONS (HS 7604) — correct HS for extrusions (7606 = plates, 7604 = extrusions)
  { hs_code: "7604", product_name: "Aluminum Extrusions", destination_country: "United States", destination_code: "US", origin_country: null, origin_code: null, retaliation_rate: 10, retaliation_note: "US Section 232 (Proclamation 9704, 2018) — 10% on aluminum extrusions from most countries. Canada/Mexico/UK exempt." },
  { hs_code: "7604", product_name: "Aluminum Extrusions", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 374, retaliation_note: "US ADD/CVD on Chinese aluminum extrusions (DOC final determination) — anti-dumping ~347% + CVD ~27% = ~374% additional. Stacks on Section 232 (10%). One of the highest ADD rates in force." },
  // Aluminum PLATES/SHEETS (HS 7606) — Section 232 already stored globally above, this is China Section 301 only
  { hs_code: "7606", product_name: "Aluminum plates/sheets", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 35, retaliation_note: "US Section 232 (10%) + Section 301 Biden 2024 (25%) on Chinese aluminum plates/sheets — total 35% China-specific additional duties." },
  // Steel ADD/CVD — China (265% ADD/CVD is the dominant China-specific rate; 232 global 25% stacks separately)
  { hs_code: "7208", product_name: "Steel (Cold-Rolled/Corrosion-Resistant)", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 265, retaliation_note: "US ADD/CVD on Chinese cold-rolled/CORE steel — anti-dumping 265% + CVD 256% (DOC 2016 final). Stacks on Section 232 (25% global). Total Chinese steel: ~290% additional." },
  { hs_code: "7208", product_name: "Steel (flat-rolled)", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 35, retaliation_note: "US ADD on Indian cold-rolled/corrosion-resistant steel — anti-dumping margins typically 3.7-35% (DOC annual reviews). Stacks on Section 232 (25%). Total: up to 60% on Indian steel." },
  { hs_code: "0306", product_name: "Shrimp/Prawns", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 10, retaliation_note: "US ADD on Indian frozen shrimp (DOC A-533-840) — anti-dumping rates typically 0-10%. Check DOC case registry for company-specific rates." },
  // ── AD/CVD orders on Indian goods (India→US corridor coverage) ────────────
  { hs_code: "7306", product_name: "Welded Steel Pipe/Tube", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 20, retaliation_note: "US ADD/CVD on Indian welded carbon steel pipe (incl. A-533-502, one of the oldest active orders) — company-specific margins vary widely. Stacks on Section 232 (25%). Check DOC registry for your producer." },
  { hs_code: "7307", product_name: "Steel Flanges/Fittings", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 78, retaliation_note: "US ADD/CVD on Indian stainless steel flanges (A-533-877/C-533-878, 2018) and forged steel fittings (A-533-891) — combined margins can reach 78%+ for non-cooperative producers." },
  { hs_code: "6810", product_name: "Quartz Surface Products", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 5, retaliation_note: "US ADD/CVD on Indian quartz surface products (A-533-889/C-533-890, 2020) — most producers ~2-5% combined; non-cooperative rates far higher. Company-specific — check DOC registry." },
  { hs_code: "7606", product_name: "Aluminum Sheet", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 49, retaliation_note: "US ADD/CVD on Indian common alloy aluminum sheet (A-533-895/C-533-896, 2021) — combined margins up to ~49%. Stacks on Section 232 aluminum (10%)." },
  { hs_code: "4011", product_name: "Off-the-Road Tires", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 9, retaliation_note: "US ADD/CVD on Indian new pneumatic off-the-road tires (A-533-869/C-533-870, 2017) — combined margins roughly 4-9% for cooperative producers." },
  { hs_code: "3907", product_name: "PET Resin", destination_country: "United States", destination_code: "US", origin_country: "India", origin_code: "IN", retaliation_rate: 14, retaliation_note: "US ADD/CVD on Indian PET resin (A-533-861/C-533-862) — combined margins vary by producer, roughly 5-14%. Check DOC registry for current review results." },
  // Solar — combined Section 301 (50%) + ADD/CVD (238%) in one China row (must be single DB entry per key)
  { hs_code: "8541", product_name: "Solar Cells/Panels (Section 301 + ADD/CVD)", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 288, retaliation_note: "US Section 301 Biden 2024 (50%) + ADD/CVD anti-dumping (238%) on Chinese solar cells. Stacks on Section 201 (14% global). Total Chinese solar: ~302% additional duties." },
  // ── Newly added HS codes — Section 301 China entries ──────────────────────
  { hs_code: "8504", product_name: "Power Supplies/Transformers", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 25, retaliation_note: "US Section 301 List 3 (USTR, 2018) — 25% additional on Chinese-origin electrical transformers, static converters, inductors." },
  { hs_code: "8528", product_name: "Monitors/TVs/Displays", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 7.5, retaliation_note: "US Section 301 List 4A (USTR, 2019) — 7.5% on Chinese-origin monitors and TV receivers." },
  { hs_code: "8529", product_name: "Parts for Radio/TV Apparatus", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 25, retaliation_note: "US Section 301 List 3 (USTR, 2018) — 25% on Chinese-origin parts for broadcast/communications equipment." },
  { hs_code: "8536", product_name: "Electrical Switches/Connectors", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 25, retaliation_note: "US Section 301 List 3 (USTR, 2018) — 25% on Chinese-origin electrical switches, fuses, plugs, connectors." },
  { hs_code: "8544", product_name: "Insulated Wire/Cable", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 25, retaliation_note: "US Section 301 List 3 (USTR, 2018) — 25% on Chinese-origin insulated wire, cable, and optical fiber." },
  { hs_code: "9503", product_name: "Toys/Games", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 7.5, retaliation_note: "US Section 301 List 4A (USTR, 2019) — 7.5% on Chinese-origin toys and games. China makes ~80% of US toy imports." },
  { hs_code: "6404", product_name: "Footwear (textile upper)", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 7.5, retaliation_note: "US Section 301 List 4A (USTR, 2019) — 7.5% on Chinese-origin footwear with textile uppers. Stacks on existing MFN (avg 20-37.5%)." },
  { hs_code: "8414", product_name: "Air Pumps/Compressors/Fans", destination_country: "United States", destination_code: "US", origin_country: "China", origin_code: "CN", retaliation_rate: 25, retaliation_note: "US Section 301 List 3 (USTR, 2018) — 25% on Chinese-origin air pumps, compressors, fans, ventilators." },
];
